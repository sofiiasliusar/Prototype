...
class ExpenseScreen(BoxLayout):
    def __init__(self, date, **kwargs):
        ...
        for _ in range(10):
            ...
            category_spinner = CategorySpinner(text='', height=50, category_images=category_images)
...
class ImageDropDown(DropDown):
    def __init__(self, category_images, **kwargs):
        ...
        for category, image_path in category_images.items():
            ...
            img = Image(source=image_path, size_hint_x=None, width=44)
            btn.add_widget(img)
            self.add_widget(btn)

class CategorySpinner(Spinner):
    category_images = DictProperty({})  

    def __init__(self, **kwargs):
        super(CategorySpinner, self).__init__(**kwargs)
        self.category_images = kwargs.get('category_images', {})  

    def create_dropdown(self):
        dropdown = ImageDropDown(category_images=self.category_images)
...
# with help of gpt (ask about issue)
# import sqlite3
# from kivy.app import App
# from kivy.uix.boxlayout import BoxLayout
# from kivy.uix.floatlayout import FloatLayout
...
#             sum_input = TextInput(hint_text="Sum", multiline=False, height=50)
#             description_input = DescriptionInput(hint_text="Description", multiline=False, height=50)
#             category_spinner = CategorySpinner(text='', values=categories, height=50, category_images=category_images)
...
# class ImageOption(SpinnerOption):
#     def __init__(self, option_text="", image_path="", **kwargs):
#         super().__init__(**kwargs)
#         self.clear_widgets()  # Clear existing widgets
#         image = Image(source=option_text, size_hint=(None, None), size=(50, 50))
...
#         super(CategorySpinner, self).__init__(**kwargs)
#         self.category_images = kwargs.get('category_images', {})
#         self.option_cls = ImageOption

#     def on_category_images(self, instance, value):
#         self.create_image_options()

#     def create_image_options(self):
#         self.values = list(self.category_images.keys())
# # 'assets/Sacramento-Regular.ttf'
# class ReviewScreen(Screen):
